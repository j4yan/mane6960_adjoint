...
plt.annotate('2:1', xy=(0.15, 0.71), xycoords="axes fraction", fontsize=22)
plt.annotate('4:1', xy=(0.15, 0.35), xycoords="axes fraction", fontsize=22)
plt.annotate('6:1', xy=(0.825, 0.5), xycoords="axes fraction", fontsize=22)
plt.annotate('8:1', xy=(0.825, 0.35), xycoords="axes fraction", fontsize=22)
