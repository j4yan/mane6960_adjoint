...
plt.annotate('2:1', xy=(0.15, 0.61), xycoords="axes fraction", fontsize=22)
plt.annotate('3:1', xy=(0.15, 0.50), xycoords="axes fraction", fontsize=22)
plt.annotate('4:1', xy=(0.15, 0.265), xycoords="axes fraction", fontsize=22)
plt.annotate('5:1', xy=(0.15, 0.05), xycoords="axes fraction", fontsize=22)
