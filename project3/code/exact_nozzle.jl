...
"""
    getFlowExact(area_star, x, area, temp_stag, press_stag[, subsonic=true, area_shock=area_star])
...
is located.
"""
function getFlowExact{T}(area_star::T, x::T, area::T, temp_stag::T,
                         press_stag::T; subsonic::Bool=true,
