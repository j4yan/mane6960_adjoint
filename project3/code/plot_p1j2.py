...
plt.annotate('2:1', xy=(0.25, 0.57), xycoords="axes fraction", fontsize=22)
plt.annotate('4:1', xy=(0.25, 0.075), xycoords="axes fraction", fontsize=22)
