...
#  plt.annotate('4:1', xy=(0.25, 0.32), xycoords="axes fraction", fontsize=22)
#  plt.annotate('6:1', xy=(0.25, 0.085), xycoords="axes fraction", fontsize=22)
...
plt.ylabel('$J_2$ error', fontdict=font)
