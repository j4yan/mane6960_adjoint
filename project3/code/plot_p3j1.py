...
for i in range(1):
    ...
    y2[1] = np.power(x[2], slope[2]) / np.power(x[0], slope[2]) * y2[0]
    y2[2] = y2[1]
    y2[3] = y2[0]
...
plt.annotate('6:1', xy=(0.525, 0.395), xycoords="axes fraction", fontsize=22)
plt.annotate('8:1', xy=(0.8, 0.42), xycoords="axes fraction", fontsize=22)
