...
plt.annotate('17:1', xy=(0.525, 0.295), xycoords="axes fraction", fontsize=22)
plt.annotate('22:1', xy=(0.525, 0.12), xycoords="axes fraction", fontsize=22)
